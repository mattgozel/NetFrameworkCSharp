    ...
    public class EmployeeRepository
    {
        ...
        static EmployeeRepository()
        {
            _employees = new List<Employee>()
            {
                ...
                new Employee { EmployeeId=2, FirstName="Bobby", LastName="Bones", Phone="333-333-333", DepartmentId=2},
                new Employee { EmployeeId=3, FirstName="Hobby", LastName="Hones", Phone="555-555-5555", DepartmentId=3},
            };
        }
