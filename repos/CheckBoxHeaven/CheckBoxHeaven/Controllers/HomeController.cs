...
namespace CheckBoxHeaven.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var selectedIds = model.CategoryCheckboxes.Where(c => c.IsSelected).Select(c => c.Category.CategoryId);
