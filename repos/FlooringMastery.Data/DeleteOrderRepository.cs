...
{
    public class DeleteOrderRepository : IDeleteOrder
    {
        private string _filePath;

        public DeleteOrderRepository(string filePath)
        {
            _filePath = filePath;
        }
        ...
        public DeleteOrderResponse DeleteOrder(int orderNumber, DateTime date, Order order)
        {
