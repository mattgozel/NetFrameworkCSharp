...
namespace SGBank.Tests
{
    ...
    public class BasicAccountTests
    {
        ...
        public void BasicAccountWtihdrawRuleTest(string accountNumber, string name, decimal balance, AccountType accountType, decimal amount, decimal newBalance, bool expectedResult)
        {
